...
print(f"Part 1: {sum(get_middel_num(update) for update in updates if order_ok(rules, update))}")
print(f"Part 2: {sum(get_middel_num(reorder(rules, update)) for update in updates if not order_ok(rules, update))}")
